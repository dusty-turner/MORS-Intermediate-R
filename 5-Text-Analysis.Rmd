...
book = read_file("data_sources//The-Adventures-of-Tom-Sawyer.txt") %>% enframe(name = "Book")
# book = read_file("_bookdown_files/data_sources/The-Adventures-of-Tom-Sawyer.txt") %>% enframe(name = "Book")
book
book %>% nchar()
```
