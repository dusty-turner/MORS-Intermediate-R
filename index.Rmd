...
2. Unkown number of students in class
3. Asking Quesitons - both verbally and in chat
4. Knowing if you are following along
5. Speed of going through the material

## Class Structure

1. 7 HOURS!
2. 50:10 Work to break
...
install.packages("tidyverse","janitor",dependencies = TRUE)
